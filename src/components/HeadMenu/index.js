...
class HeadMenu extends Component {
	...
	stretchMenu = (x) => {
		...
		this.setState({
			contentStyle: { transform: `translatex(${Math.floor(x / 2)}px)` }
		})
	}
						...
						>
							<aside className="b-head-menu__content" style={ this.state.contentStyle }>
									...
									<NotDesktopMin>
										<ContentItem>
											<li className="b-head-menu__content-item" key="0">
												<Link className="b-head-menu__content-text" to={ configPathRouter.authorization }>
											...
											<li className="b-head-menu__content-item" key="1">
												<Link className="b-head-menu__content-text" to={ configPathRouter.registration }>
													<span className="b-head-menu__icon-container">
								...
								{ (dataAboutRole.roleName === "Тренер") &&
									<ContentItem>
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text" to={ dataAboutRole.pathToCreateSchedule }>
												<span className="b-head-menu__icon-container">
										...
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text" to={ dataAboutRole.pathToMySchedule }>
												<span className="b-head-menu__icon-container">
										...
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text" to={ dataAboutRole.pathToManageCourt }>
												<span className="b-head-menu__icon-container">
								...
								<NotDesktopMin>
									<ul className="b-head-menu__content-list">
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text" to={ configPathRouter.listTrainer }>
												<span className="b-head-menu__icon-container">
										...
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text gl-disabled" to={ configPathRouter.myBooking }>
												<span className="b-head-menu__icon-container">
								...
								{ isAuthorization &&
									<ContentItem>
										<li className="b-head-menu__content-item">
											<Link className="b-head-menu__content-text" to={ configPathRouter.myBooking }>
												<span className="b-head-menu__icon-container">
								...
								<ContentItem>
									<li className="b-head-menu__content-item">
										<a className="b-head-menu__content-text" href="mailto:manage.playbook@gmail.com" target="_blank" title="Написать нам">
											<span className="b-head-menu__icon-container">
								...
								{ isAuthorization &&
									<ContentItem>
										<li className="b-head-menu__content-item">
											<a href="" className="b-head-menu__content-text" onClick={ this.props.onLogout }>
												<span className="b-head-menu__icon-container">
